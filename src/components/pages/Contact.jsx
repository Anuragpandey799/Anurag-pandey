...
function Contact({ dark }) {
  ...
  return (
    <>
      {/* ------------------- SEO ------------------- */}
      <Helmet>
        <title>Contact Anurag Pandey | Freelance MERN Stack Developer</title>
        <meta
          name="description"
          content="Get in touch with Anurag Pandey, a MERN stack developer and freelancer. Collaborate on web projects, hire for development, or discuss opportunities."
        />
        <meta
          name="keywords"
          content="Anurag Pandey, MERN developer, freelancer, React developer, Node.js developer, hire developer, contact developer, contact anurag, contact anurag pandey, Anurag pandey, Anurag , anurag"
        />
      ...
      >
        ...
        >
          ...
          <p className="text-lg opacity-80 max-w-2xl mx-auto">
            I'm <strong>Anurag Pandey</strong>, a MERN Stack Developer and
            Freelancer. Reach out for collaborations, freelance projects, or
            just a friendly chat about technology. Let's build amazing web
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-14 items-start">
          ...
          >
            ...
            <p className="text-lg opacity-90 leading-relaxed">
              Want to hire a freelancer, collaborate on a project, or ask a
              question? I'd love to hear from you. I'm open to short-term and
